...
function buildFavoriteQuery(extraParams) {
...
function parseDouyinTimestamp(value) {
...
function isFavoriteCollection(value) {
  return value !== null;
}
...
export async function resolveDouyinFavoriteCollectionId(page, requestedId) {
...
async function findSignedFavoriteItemsUrl(page, collectionId) {
...
export async function fetchDouyinFavoriteCollections(page, limit) {
...
export async function fetchDouyinFavoriteItems(page, collectionId, limit, fetchAll) {
